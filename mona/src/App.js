			...
			<Routes>
				...
				<Route element={<ProtectedRoute />}>
					<Route element={<AdminNavbar />}>
						...
						<Route path="/admin/home-image" element={<Navigate to="/admin/manageproducts" replace />} />
						<Route path="/admin/hero-image" element={<Navigate to="/admin/manageproducts" replace />} />
